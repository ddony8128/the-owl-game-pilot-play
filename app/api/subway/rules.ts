...
export const SUBWAY_RULES: SubwayRule[] = [
  {
    ...
    body:
      ...
      "본 시설에 고립된 지 50분 이내로 탈출하지 못할 경우, 더 이상 안전을 보장해드릴 수 없습니다.",
    conditionDescription: "기본 안내문입니다. 처음부터 항상 보입니다.",
    alwaysVisible: true,
  },
  {
    id: 1,
    ...
    body:
      ...
      "시공간 좌표가 고정된 이후에야 이동이 성립하므로, 각 공간에서 30초 이상 머무르시기 바랍니다. " +
      "이를 지키지 않으면 어느 시간대에서도 존재할 수 없게 됩니다.",
    conditionDescription: "한 장소에서 30초 이상 머무르면 공개됩니다.",
    alwaysVisible: false,
  },
  {
    id: 2,
    ...
    conditionDescription: "밀담실에 입장하면 공개됩니다.",
    alwaysVisible: false,
  },
  {
    id: 3,
    ...
    conditionDescription: "식당에서 간식을 챙기면 공개됩니다.",
    alwaysVisible: false,
  },
  {
    id: 4,
    ...
    body:
      ...
      "그들은 이상현상과 동화되어 더 이상 인간이 아닙니다. 그들을 마주친다면 가능한 한 즉시 뒤로 돌아가십시오.",
    conditionDescription: "수배범 신고를 성공적으로 처리하면 공개됩니다.",
    alwaysVisible: false,
  },
  {
    id: 5,
    ...
    body:
      ...
      "즉시 뒤돌아가십시오. 당신의 기억을 실체화하는 무언가가 그곳에 있는 것입니다.",
    conditionDescription: "같은 장소를 3번 마주하면 공개됩니다.",
    alwaysVisible: false,
  },
  {
    id: 6,
    ...
    conditionDescription:
      "6번 출구까지 도달한 후 0번 출구로 되돌아가면 공개됩니다.",
    alwaysVisible: false,
  },
  {
    id: 7,
    ...
    body:
      ...
      "이 규칙이 마지막 규칙입니다.",
    conditionDescription:
      "규칙 1부터 규칙 6까지를 모두 발견하면 자동으로 공개됩니다.",
    alwaysVisible: false,
  },
  {
    id: 8,
    ...
    body:
      ...
      "그가 과연 사람일까요?",
    conditionDescription:
      "가짜 규칙입니다. 처음부터 끝까지 항상 보이는 상태로 유지됩니다.",
    alwaysVisible: true,
  },
];
