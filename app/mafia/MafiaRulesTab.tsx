      ...
      <div className="space-y-3">
        ...
        <ul className="list-disc pl-4">
          ...
          <li>
            ...
            사람은 경제사범이 됩니다. 마피아가 경제사범으로 뽑히면 국채 가격이 1
            오르고, 모든 시민은 국채를 1개씩 얻습니다. 반대로 마피아가 경제사범으로
            뽑히지 않으면(동점/무투표 포함), 모든 마피아는 그 시점에서 가장 비싼
            주식 1주를 받습니다. 가장 비싼 주식이 여러 종류라면 각 마피아에게
            랜덤으로 지급됩니다. 마피아 여부와 상관 없이 경제사범은 국채 가격만큼
            벌금을 냅니다. 다음 라운드로 넘어가거나 게임을 종료합니다. 총
            5라운드입니다.
          </li>
        </ul>
      </div>
      ...
      <div className="space-y-1">
        ...
        <ul className="list-disc pl-4">
          ...
          <li>
            ...
            두 명을 대상으로 지정해, 각 대상의 이번 라운드 수익의 25%(버림)를
          ...
          <li>
            ...
            자신을 제외한 두 명을 조사해, 그 두 명 중 마피아가 있는지 알 수
            있습니다. 그 라운드에서 마피아가 경제사범이 되면 국채를 하나
            받습니다.
          </li>
          <br />
          <li>
